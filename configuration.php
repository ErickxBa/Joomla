...
class JConfig {
	...
	public $host = getenv("MYSQLHOST") ?: 'localhost';
	public $user = getenv("MYSQLUSER") ?: 'root';
	public $password = getenv("MYSQLPASSWORD") ?: '';
	public $db = getenv("MYSQLDATABASE") ?: 'joomla_db';
	...
	public $force_ssl = 0;
	public $live_site = '';
	public $secret = '4xLbdoFtzMXY39gG';
	public $gzip = false;
	...
	public $mailer = 'mail';
	public $mailfrom = 'sebasballas@gmail.com';
	public $fromname = 'erickballas';
